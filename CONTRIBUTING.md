...
6. This triggers the [release pipeline on GitHub](https://github.com/grafana/redshift-datasource/actions/workflows/release.yml).
...
8. Check that the release is published to [grafana.com](https://grafana.com/grafana/plugins/grafana-azure-data-explorer-datasource).
